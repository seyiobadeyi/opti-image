...
const TOOLS: Tool[] = [
    ...
    },
    {
        ...
        desc: 'Strip hidden camera data — GPS location, device info and EXIF — before you share.',
        href: '/compress',
        Icon: ShieldOff,
        iconBg: '#fef2f2',
        iconColor: '#dc2626',
    ...
    {
        name: 'Crop Image',
        desc: 'Trim your images to a specific area or aspect ratio — portrait, landscape, square.',
        href: '/compress',
        Icon: Scissors,
        iconBg: '#fff1f2',
        iconColor: '#e11d48',
