    ...
    return (
        <div style={{ background: '#fff', minHeight: '100vh', color: '#111827' }}>
            ...
            <main style={{ maxWidth: '780px', margin: '0 auto', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
                ...
                <h1 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '8px', color: '#111827' }}>
                    Terms of Service
                </h1>
                <p style={{ color: '#9ca3af', fontSize: '0.88rem', marginBottom: '48px' }}>
                    Effective date: 1 April 2026. These terms govern your use of Optimage, a product of Dream Intrepid Ltd.
                </p>

                {/* ── 1 ── */}
                <section style={{ marginBottom: '40px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    <h2 style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '14px', color: '#111827' }}>
                        1. About Optimage
                    </h2>
                ...
                <section style={{ marginBottom: '40px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    ...
                    <p style={{ lineHeight: 1.75, color: '#374151', marginBottom: '12px' }}>
                ...
                <section style={{ marginBottom: '40px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    ...
                    <h3 style={{ fontSize: '1.05rem', fontWeight: 700, marginBottom: '10px', marginTop: '20px', color: '#111827' }}>
                ...
                <section style={{ marginBottom: '40px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    ...
                    <p style={{ lineHeight: 1.75, color: '#374151', marginBottom: '14px' }}>
                        You agree not to use the service to:
                    </p>
                    <ul style={{ lineHeight: 1.75, color: '#374151', paddingLeft: '24px' }}>
                    ...
                    <p style={{ lineHeight: 1.75, color: '#374151', marginTop: '14px' }}>
                ...
                <section style={{ marginBottom: '40px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    ...
                    <p style={{ lineHeight: 1.75, color: '#374151' }}>
                        ...
                        <a href="mailto:privacy@dreamintrepid.com" style={{ color: '#e8866f', textDecoration: 'none' }}>
                ...
                {/* ── 15 ── */}
                <section style={{ marginBottom: '60px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
                    <h2 style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '14px', color: '#111827' }}>
                        15. Contact
                    </h2>
                    <p style={{ lineHeight: 1.75, color: '#374151', marginBottom: '12px' }}>
                    ...
                    <div style={{ background: '#f9fafb', borderRadius: '12px', padding: '20px 24px', border: '1px solid #e5e7eb' }}>
                        <p style={{ margin: '0 0 4px', fontWeight: 600, color: '#111827' }}>Dream Intrepid Ltd</p>
                        <p style={{ margin: '0 0 4px', color: '#374151', fontSize: '0.92rem' }}>
                            General enquiries:{' '}
                            <a href="mailto:optimage@dreamintrepid.com" style={{ color: '#e8866f', textDecoration: 'none' }}>
                                optimage@dreamintrepid.com
                            </a>
