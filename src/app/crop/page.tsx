...
export const metadata: Metadata = {
    title: 'Crop Image - Coming Soon | Optimage',
    description: 'Crop images to a specific area or aspect ratio. Portrait, landscape or square. Coming soon to Optimage.',
};
        ...
        <div style={{ minHeight: '100vh', background: '#fff', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", color: clr.g900 }}>
            ...
            <div style={{ maxWidth: '640px', margin: '0 auto', padding: '80px 24px', textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '1.05rem', color: clr.g700, lineHeight: 1.7, marginBottom: '40px' }}>
                    Trim your images to a specific area or aspect ratio. Portrait, landscape or square. We&apos;re putting the finishing touches on this tool.
                </p>
                ...
                <div style={{ background: '#f9fafb', border: `1px solid ${clr.g200}`, borderRadius: '16px', padding: '28px', marginBottom: '36px', textAlign: 'left' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        {[
                            ...
                            <Link key={t.href} href={t.href} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderRadius: '10px', background: '#fff', border: `1px solid ${clr.g200}`, textDecoration: 'none', transition: 'border-color 0.15s' }}>
                                <div>
