...
export const metadata: Metadata = {
    ...
    description: 'Deliver stunning photo galleries to your clients for free. Draft mode, client favourites, payment gate, PIN protection, photographer branding — all in one platform. No commission. No per-gallery fees.',
    ...
    openGraph: {
        title: 'Client Gallery Delivery for Photographers | Optimage',
        description: 'The gallery platform built for photographers who deliver. Private galleries, client favourites, payment confirmation, expiry reminders. Free with your Optimage account.',
    ...
    twitter: { card: 'summary_large_image', title: 'Client Gallery Delivery | Optimage', description: 'Deliver photo galleries. Gate access. Confirm payment. Let clients pick favourites. Free with Optimage.' },
...
const jsonLd = {
    ...
    url: 'https://optimage.dreamintrepid.com/galleries',
    offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD', description: 'Free with a free Optimage account. No credit card required.' },
    featureList: [
